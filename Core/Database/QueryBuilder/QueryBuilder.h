#ifndef MELLIANCORE_QUERYBUILDER_H
#define MELLIANCORE_QUERYBUILDER_H

#include <vector>

// kudos to https://github.com/six-ddc/sql-builder
namespace QueryBuilder
{
    ...
    public:
        ...
        column &inRaw(const std::string &s)
        {
            _cond.append(" IN (");
            _cond.append(s);
            _cond.append(")");
    ...
    inline static SelectModel *select(const std::string &s = "*")
    {
        auto select = new SelectModel;
...
#endif //MELLIANCORE_QUERYBUILDER_H
